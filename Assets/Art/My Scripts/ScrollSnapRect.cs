...
public class ScrollSnapRect : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler {
    ...
    public GameObject DropDownn,DropButton,piano,UpButton,settingsUp,settingsDown,SettingsMenu,AboutUs;
    ...
    private void NextScreen()
    {
        ...
        if (_currentPage == (GameObject.Find("Contents").transform.childCount-1))
        {
    ...
    public void OnClick(string name)
    {
        if(name == "DropDown")
        {
            ...
            settingsDown.SetActive(true);
            settingsUp.SetActive(false);
        ...
        else if(name == "SettingsDown")
        {
            settingsDown.SetActive(false);
            settingsUp.SetActive(true);
